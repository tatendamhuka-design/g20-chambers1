        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center justify-between gap-2 text-xs md:text-sm">
            <div className="flex flex-wrap items-center gap-3 md:gap-4 text-[#0a1628] font-medium">
              <a href="tel:+27823413333" className="flex items-center gap-1.5 hover:text-white transition-colors">
                <Phone className="w-3 h-3 md:w-3.5 md:h-3.5" />
                <span>082 341 3333</span>
              </a>
              <span className="text-[#0a1628]/30">|</span>
              <a href="tel:+27158801865" className="flex items-center gap-1.5 hover:text-white transition-colors">
                <Phone className="w-3 h-3 md:w-3.5 md:h-3.5" />
                <span>015 880 1865</span>
              </a>
              <span className="text-[#0a1628]/30 hidden sm:inline">|</span>
              <a href="mailto:cali.mathabatha@gmail.com" className="hidden sm:flex items-center gap-1.5 hover:text-white transition-colors">
                <Mail className="w-3 h-3 md:w-3.5 md:h-3.5" />
                <span>cali.mathabatha@gmail.com</span>
              </a>
            </div>
            <div className="flex items-center gap-2 md:gap-3">
              <a href="https://maps.google.com/?q=39+Voortrekker+Street+Polokwane" target="_blank" rel="noopener noreferrer" className="hidden md:flex items-center gap-1.5 text-[#0a1628] hover:text-white transition-colors text-xs font-medium">
                <MapPin className="w-3 h-3" />
                <span>39 Voortrekker St, Polokwane</span>
              </a>
              <a href="https://wa.me/27823413333" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 bg-[#25D366] text-white px-2.5 py-0.5 md:px-3 md:py-1 rounded-full text-xs font-semibold hover:bg-[#1da851] transition-colors">
      ...
      <div className="bg-[#0a1628] border-b-4 border-[#c9a84c]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            <Link href="/" className="flex items-center gap-3 md:gap-4 group flex-shrink-0" suppressHydrationWarning>
              {!imgError ? (
        ...
        <div className="lg:hidden bg-[#0a1628] border-t border-[#1a2a3a]">
          <div className="container py-4 space-y-3">
            ...
            <div className="pt-4 border-t border-[#1a2a3a] space-y-2">
              <a href="tel:+27823413333" className="flex items-center gap-2 text-sm text-gray-400 hover:text-[#c9a84c] transition-colors">
                <Phone className="w-4 h-4 text-[#c9a84c]" />
                082 341 3333
              </a>
              <a href="tel:+27158801865" className="flex items-center gap-2 text-sm text-gray-400 hover:text-[#c9a84c] transition-colors">
                <Phone className="w-4 h-4 text-[#c9a84c]" />
                015 880 1865
              </a>
              <a href="mailto:cali.mathabatha@gmail.com" className="flex items-center gap-2 text-sm text-gray-400 hover:text-[#c9a84c] transition-colors">
                <Mail className="w-4 h-4 text-[#c9a84c]" />
                cali.mathabatha@gmail.com
              </a>
              <a href="https://wa.me/27823413333" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm bg-[#25D366] text-white px-4 py-2 rounded-lg font-medium hover:bg-[#1da851] transition-colors w-fit">
